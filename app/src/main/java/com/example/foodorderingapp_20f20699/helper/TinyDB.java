...
public class TinyDB {
    ...
    public ArrayList<FoodDmen> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodDmen> playerList =  new ArrayList<FoodDmen>();

        for(String jObjString : objStrings){
            FoodDmen player  = gson.fromJson(jObjString,  FoodDmen.class);
    ...
    public void putListObject(String key, ArrayList<FoodDmen> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodDmen player: playerList){
